...
const CreateUsers = ({ errors, editUsers }) => {
    ...
    const handleSubmit = (e) => {
        ...
        Inertia.post(route("users.store"), formData, {
            onSuccess: () => {
                swal("Keren!", "Anda berhasil menambahkan User!", "success");
            },
        });
    };
    ...
    const handleUpdate = (e) => {
        ...
        Inertia.post(route("users.update", editUsers.id), formData, {
            onSuccess: () => {
                swal("Cakep!", "Anda berhasil merubah User!", "success");
            },
        });
    };
    ...
    const styles = {
        ...
        classNameLabel : "text-md text-blue-300 mb-2 font-semibold uppercase",
